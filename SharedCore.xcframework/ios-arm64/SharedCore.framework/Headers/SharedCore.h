...
__attribute__((swift_name("DimmerBaseValue")))
@protocol SharedCoreDimmerBaseValue
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DimmerValue")))
@interface SharedCoreDimmerValue : SharedCoreBase <SharedCoreDimmerBaseValue>
@property (class, readonly, getter=companion) SharedCoreDimmerValueCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t brightness __attribute__((swift_name("brightness")));
@property (readonly) BOOL on __attribute__((swift_name("on")));
@property (readonly) SharedCoreSuplaChannelAvailabilityStatus *status __attribute__((swift_name("status")));
- (instancetype)initWithStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status on:(BOOL)on brightness:(int32_t)brightness __attribute__((swift_name("init(status:on:brightness:)"))) __attribute__((objc_designated_initializer));
- (SharedCoreDimmerValue *)doCopyStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status on:(BOOL)on brightness:(int32_t)brightness __attribute__((swift_name("doCopy(status:on:brightness:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("DimmerValue.Companion")))
@interface SharedCoreDimmerValueCompanion : SharedCoreBase
@property (class, readonly, getter=shared) SharedCoreDimmerValueCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (SharedCoreDimmerValue *)fromStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status bytes:(SharedCoreKotlinByteArray *)bytes __attribute__((swift_name("from(status:bytes:)")));
@end

__attribute__((swift_name("RgbBaseValue")))
@protocol SharedCoreRgbBaseValue
@required
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RgbValue")))
@interface SharedCoreRgbValue : SharedCoreBase <SharedCoreRgbBaseValue>
@property (class, readonly, getter=companion) SharedCoreRgbValueCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t blue __attribute__((swift_name("blue")));
@property (readonly) int32_t colorBrightness __attribute__((swift_name("colorBrightness")));
@property (readonly) int32_t green __attribute__((swift_name("green")));
@property (readonly) BOOL on __attribute__((swift_name("on")));
@property (readonly) int32_t red __attribute__((swift_name("red")));
@property (readonly) SharedCoreSuplaChannelAvailabilityStatus *status __attribute__((swift_name("status")));
- (instancetype)initWithStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status on:(BOOL)on colorBrightness:(int32_t)colorBrightness red:(int32_t)red green:(int32_t)green blue:(int32_t)blue __attribute__((swift_name("init(status:on:colorBrightness:red:green:blue:)"))) __attribute__((objc_designated_initializer));
- (SharedCoreRgbValue *)doCopyStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status on:(BOOL)on colorBrightness:(int32_t)colorBrightness red:(int32_t)red green:(int32_t)green blue:(int32_t)blue __attribute__((swift_name("doCopy(status:on:colorBrightness:red:green:blue:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RgbValue.Companion")))
@interface SharedCoreRgbValueCompanion : SharedCoreBase
@property (class, readonly, getter=shared) SharedCoreRgbValueCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (SharedCoreRgbValue *)fromStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status bytes:(SharedCoreKotlinByteArray *)bytes __attribute__((swift_name("from(status:bytes:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RgbwValue")))
@interface SharedCoreRgbwValue : SharedCoreBase <SharedCoreRgbBaseValue, SharedCoreDimmerBaseValue>
@property (class, readonly, getter=companion) SharedCoreRgbwValueCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) int32_t blue __attribute__((swift_name("blue")));
@property (readonly) int32_t brightness __attribute__((swift_name("brightness")));
@property (readonly) int32_t colorBrightness __attribute__((swift_name("colorBrightness")));
@property (readonly) int32_t green __attribute__((swift_name("green")));
...
@property (readonly) int32_t red __attribute__((swift_name("red")));
@property (readonly) SharedCoreSuplaChannelAvailabilityStatus *status __attribute__((swift_name("status")));
- (instancetype)initWithStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status on:(BOOL)on brightness:(int32_t)brightness colorBrightness:(int32_t)colorBrightness red:(int32_t)red green:(int32_t)green blue:(int32_t)blue __attribute__((swift_name("init(status:on:brightness:colorBrightness:red:green:blue:)"))) __attribute__((objc_designated_initializer));
- (SharedCoreRgbwValue *)doCopyStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status on:(BOOL)on brightness:(int32_t)brightness colorBrightness:(int32_t)colorBrightness red:(int32_t)red green:(int32_t)green blue:(int32_t)blue __attribute__((swift_name("doCopy(status:on:brightness:colorBrightness:red:green:blue:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RgbwValue.Companion")))
@interface SharedCoreRgbwValueCompanion : SharedCoreBase
@property (class, readonly, getter=shared) SharedCoreRgbwValueCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (SharedCoreRgbwValue *)fromStatus:(SharedCoreSuplaChannelAvailabilityStatus *)status bytes:(SharedCoreKotlinByteArray *)bytes __attribute__((swift_name("from(status:bytes:)")));
@end
