...
+ (id<SharedCoreLocalizedString> _Nullable)channelIdString:(id<SharedCoreSuplaChannelStatePrintable>)receiver __attribute__((swift_name("channelIdString(_:)")));
