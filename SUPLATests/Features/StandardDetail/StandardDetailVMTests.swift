...
final class StandardDetailVMTests: ViewModelTest<StandardDetailViewState, StandardDetailViewEvent> {
    
    private lazy var viewModel: StandardDetailVM! = { StandardDetailVM() }()
