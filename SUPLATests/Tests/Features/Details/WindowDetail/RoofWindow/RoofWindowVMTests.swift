...
final class RoofWindowVMTests: ViewModelTest<RoofWindowViewState, BaseWindowViewEvent> {
    ...
    private lazy var viewModel: RoofWindowVM! = RoofWindowVM()
    ...
    func test_shouldLoadGroup() {
        ...
        assertStates(expected: [
            ...
            RoofWindowViewState(
                remoteId: 234,
                roofWindowState: RoofWindowState(
