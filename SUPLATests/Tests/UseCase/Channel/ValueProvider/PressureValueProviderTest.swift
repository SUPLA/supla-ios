//
//  PressureValueProviderTest.swift
//  SUPLATests
//
...
final class PressureValueProviderTest: XCTestCase {
    private lazy var provider: PressureValueProvider! = PressureValueProviderImpl()
    ...
    func test_shouldHandleFunction() {
        // given
        let channel = SAChannel.mock(function: SUPLA_CHANNELFNC_PRESSURESENSOR)
    ...
    func test_shouldGetUnknownValue() {
        ...
        // then
        XCTAssertEqual(value as! Double, PressureValueProviderImpl.UNKNOWN_VALUE)
    }
}
