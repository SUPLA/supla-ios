...
final class DeleteAllProfileDataUseCaseTests: UseCaseTest<Void> {
    ...
    func test() {
        ...
        electricityMeasurementItemRepository.deleteAllMock.returns = .single(.just(()))
        ...
        XCTAssertEqual(electricityMeasurementItemRepository.deleteAllMock.parameters.count, 1)
