...
final class ExecuteRollerShutterActionUseCaseTests: CompletableTestCase {
    ...
    private lazy var useCase: ExecuteRollerShutterActionUseCase! = ExecuteRollerShutterActionUseCaseImpl()
