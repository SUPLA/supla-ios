...
final class CreateProfileGroupsListUseCaseTests: UseCaseTest<[List]> {
    
    private lazy var useCase: CreateProfileGroupsListUseCase! = { CreateProfileGroupsListUseCaseImpl() }()
