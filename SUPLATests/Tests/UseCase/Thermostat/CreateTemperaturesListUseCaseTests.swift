...
final class CreateTemperaturesListUseCaseTests: XCTestCase {
    private lazy var useCase: CreateTemperaturesListUseCase! = CreateTemperaturesListUseCaseImpl()
    
    private lazy var groupSharedSettings: GroupShared.SettingsMock! = GroupShared.SettingsMock()
    
    private lazy var getChannelBaseIconUseCaseMock: GetChannelBaseIconUseCaseMock! = GetChannelBaseIconUseCaseMock()
