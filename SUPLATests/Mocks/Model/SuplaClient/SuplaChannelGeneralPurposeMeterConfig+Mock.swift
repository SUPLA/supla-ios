...
extension SuplaChannelGeneralPurposeMeterConfig {
    static func mock(
        remoteId: Int32 = 0,
        ...
        counterType: SuplaChannelConfigMeterCounterType = .incrementAndDecrement,
        chartType: SuplaChannelConfigMeterChartType = .bar,
        includeValueAddedInHistory: Bool = false,
        fillMissingData: Bool = false
