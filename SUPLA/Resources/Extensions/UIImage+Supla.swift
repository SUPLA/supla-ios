...
extension UIImage {
    ...
    static let iconSoundOn = UIImage(named: .Icons.soundOn)
    static let iconSoundOff = UIImage(named: .Icons.soundOff)
    static let iconUpdate = UIImage(named: .Icons.update)
    static let iconSearch = UIImage(named: .Icons.search)
