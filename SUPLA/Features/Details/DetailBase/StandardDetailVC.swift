...
class StandardDetailVC: BaseDetailVC<StandardDetailViewState, StandardDetailViewEvent, StandardDetailVM> {
    
    init(item: ItemBundle, pages: [DetailPage]) {
        super.init(viewModel: StandardDetailVM(), item: item, pages: pages)
    }
