...
final class RoofWindowVM: BaseWindowVM<RoofWindowViewState> {
    override func defaultViewState() -> RoofWindowViewState { RoofWindowViewState() }
    ...
    override func handleChannel(_ channel: SAChannel) {
        ...
        updateView {
            ...
            let windowState = $0.roofWindowState
            ...
            return updateChannel($0, channel, value) {
                $0.changing(path: \.roofWindowState, to: windowState)
            }
        }
    }
    ...
    override func handleGroup(_ group: SAChannelGroup, _ onlineSummary: GroupOnlineSummary) {
        updateView {
            ...
            let overallPosition = getGroupPercentage(positions, !$0.roofWindowState.markers.isEmpty)
            let windowState = $0.roofWindowState
...
struct RoofWindowViewState: BaseWindowViewState {
    var remoteId: Int32? = nil
    var roofWindowState: RoofWindowState = .init(position: .similar(0))
    ...
    var windowState: any WindowState { roofWindowState }
}
