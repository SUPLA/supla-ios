...
final class ProjectorScreenVM: BaseWindowVM<ProjectorScreenViewState> {
    ...
    override func handleChannel(_ channel: SAChannel) {
        ...
        updateView {
            ...
            let windowState = $0.projectorScreenState
            ...
            return updateChannel($0, channel, value) {
                $0.changing(path: \.projectorScreenState, to: windowState)
            }
        }
    }
    ...
    override func handleGroup(_ group: SAChannelGroup, _ onlineSummary: GroupOnlineSummary) {
        updateView {
            ...
            let overallPosition = getGroupPercentage(positions, !$0.projectorScreenState.markers.isEmpty)
            let windowState = $0.projectorScreenState
...
struct ProjectorScreenViewState: BaseWindowViewState {
    ...
    var windowState: any WindowState { projectorScreenState }
}
