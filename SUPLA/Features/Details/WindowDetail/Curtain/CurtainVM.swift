...
final class CurtainVM: BaseWindowVM<CurtainViewState> {
    override func defaultViewState() -> CurtainViewState { CurtainViewState() }
    ...
    override func handleChannel(_ channel: SAChannel) {
        ...
        updateView {
            ...
            let windowState = $0.curtainWindowState
            ...
            return updateChannel($0, channel, value) {
                $0.changing(path: \.curtainWindowState, to: windowState)
            }
        }
    }
    ...
    override func handleGroup(_ group: SAChannelGroup, _ onlineSummary: GroupOnlineSummary) {
        updateView {
            ...
            let overallPosition = getGroupPercentage(positions, !$0.curtainWindowState.markers.isEmpty)
            let windowState = $0.curtainWindowState
...
struct CurtainViewState: BaseWindowViewState {
    var remoteId: Int32? = nil
    var curtainWindowState: CurtainWindowState = .init(position: .similar(0))
    ...
    var windowState: any WindowState { curtainWindowState }
}

private extension SAChannelGroup {
    func getCurtainPositions() -> [CGFloat] {
