...
extension AddWizardFeature {
    struct AddWizardManualReconnect: SwiftUI.View {
        let onCancel: () -> Void
        let onNext: () -> Void
        let onSettings: () -> Void
        ...
        var body: some SwiftUI.View {
            AddWizardFeature.AddWizardScaffold(
                ...
                AddWizardFeature.AddWizardContentText(text: Strings.AddWizard.manualReconnectMessage)
                
                AddWizardFeature.SettingsButton { onSettings() }
