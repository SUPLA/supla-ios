...
class ThermostatHistoryDetailVC: BaseViewControllerVM<ThermostatHistoryDetailViewState, ThermostatHistoryDetailViewEvent, ThermostatHistoryDetailVM> {
    ...
    override func handle(event: ThermostatHistoryDetailViewEvent) {
    }
    
    override func handle(state: ThermostatHistoryDetailViewState) {
