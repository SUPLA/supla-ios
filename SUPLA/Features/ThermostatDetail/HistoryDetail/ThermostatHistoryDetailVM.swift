...
class ThermostatHistoryDetailVM: BaseViewModel<ThermostatHistoryDetailViewState, ThermostatHistoryDetailViewEvent> {
    ...
    override func defaultViewState() -> ThermostatHistoryDetailViewState { ThermostatHistoryDetailViewState() }
    ...
    private func moveToDate(state: ThermostatHistoryDetailViewState, date: Date?) -> ThermostatHistoryDetailViewState {
    ...
    private func restoreRange(chartState: TemperatureChartState) {
    ...
    private func triggerMeasurementsLoad(state: ThermostatHistoryDetailViewState) {
    ...
    private func measurementsObservable(remoteId: Int32, start: Date, end: Date, aggregation: ChartDataAggregation) -> Observable<([HistoryDataSet], DaysRange?)> {
        Observable.zip(
...
enum ThermostatHistoryDetailViewEvent: ViewEvent {
}

struct ThermostatHistoryDetailViewState: ViewState {
    ...
    func shiftRange(chartRange: ChartRange, forward: Bool) -> ThermostatHistoryDetailViewState {
