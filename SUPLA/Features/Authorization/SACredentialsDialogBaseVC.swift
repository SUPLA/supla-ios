...
class SACredentialsDialogVC<VM: SACredentialsDialogVM>: SACustomDialogVC<SACredentialsDialogViewState, SACredentialsDialogViewEvent, SACredentialsDialogVM> {
    ...
    override func handle(state: SACredentialsDialogViewState) {
    ...
    override func handle(event: SACredentialsDialogViewEvent) {
        switch (event) {
