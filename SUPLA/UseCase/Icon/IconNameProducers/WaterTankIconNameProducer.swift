...
final class WaterTankIconNameProducer: IconNameProducer {
    ...
    func produce(iconData: FetchIconData) -> String {
        ...
        case 3: addStateSuffix(name: .Icons.fncWaterTank3, state: iconData.state)
        default: addStateSuffix(name: .Icons.fncWaterTank, state: iconData.state)
        }
    }
}
