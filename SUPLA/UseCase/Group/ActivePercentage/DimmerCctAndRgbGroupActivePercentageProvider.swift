...
final class DimmerCctAndRgbGroupActivePercentageProvider: GroupActivePercentageProvider {
    func handleFunction(_ function: Int32) -> Bool {
        function == SUPLA_CHANNELFNC_DIMMER_CCT_AND_RGB
    }
    
    func getActivePercentage(_ valueIndex: Int, _ totalValue: GroupTotalValue) -> Int {
        return totalValue.values
            .map { $0 as! DimmerCctAndRgbGroupValue }
