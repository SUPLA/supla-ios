        ...
        ListItemScaffold(
            ...
            ListItemMainRow {
                ...
                if (scaleFactor <= 1) {
                    ...
                    SetpointTemperature(icon: item.indicatorIcon, subValue: item.subValue)
                } else {
                    VStack(spacing: 0) {
                        ListItemValue(value: item.base.value ?? "")
                        SetpointTemperature(icon: item.indicatorIcon, subValue: item.subValue)
